...
def main():
    ...
    if not run_command(
        ...
        "Generating 2000 vehicles with high congestion..."
    ):
        return
    ...
    # Get absolute path to network file
    import os
    net_file = os.path.abspath('data/sumo/map.net.xml')
    # Or if your network is in data/generated:
    # net_file = os.path.abspath('data/generated/sumo/map.net.xml')
